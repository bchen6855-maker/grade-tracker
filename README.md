...
```bash
grade-tracker add-course "CS101" --target 90
```
...
```bash
grade-tracker add-assignment "CS101" "Midterm" --weight 30 --score 84
grade-tracker add-assignment "CS101" "Final Exam" --weight 50
```
...
```
$ grade-tracker add-course "CS101" --target 90
Course 'CS101' added with target 90.0%.

$ grade-tracker add-assignment "CS101" "Homework 1" --weight 10 --score 88
$ grade-tracker add-assignment "CS101" "Midterm"    --weight 40 --score 84
$ grade-tracker add-assignment "CS101" "Final Exam" --weight 50
...
┡━━━━━━━╇━━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━┩
│ CS101 │ 84.4%         │ 90.0%        │ 50.0%            │
└───────┴───────────────┴──────────────┴──────────────────┘

$ grade-tracker needs "CS101"
You need to score 94.9% on remaining assignments to reach your target score in 'CS101'.
```
